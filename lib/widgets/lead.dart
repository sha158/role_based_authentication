...
class LeadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text("You are a lead Developer",style: GoogleFonts.lato(fontSize: 25,fontWeight: FontWeight.bold),),
        SizedBox(height: 30,),
        Container(
          height: 40,
        ...
        Row(
          ...
          child: Center(child: Text("View user!!!",style: TextStyle(color: Colors.white),)),
        ...
        Container(
          ...
          child: Center(child: Text("block user!!",style: TextStyle(color: Colors.white),)),
